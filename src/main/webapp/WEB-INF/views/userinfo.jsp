                ...
                <div id="nameWrap">
                    ...
                    <input type="text" id="username" name="username" 
                    	value="${member.username != null ? member.username :
                    			 member.naverId != null ? member.naverId : member.googleId}" readonly>
                </div>
                <div id="infoWrap">
                	<div id="emailWrap">
                	...
                	<div id="telWrap">
	                	...
	                	<input type="text" class="inp" id="tel" name="tel" value="${member.tel}" readonly placeholder="전화번호">
...
function enableEdit() {
    ...
    // 변경 전 값 저장(checkbox 예외 처리)
    inputs.forEach(input => {
        if (input.name) { // name이 있는 input만
            if (input.type === "checkbox") {
                originalValues[input.name] = input.checked ? "Y" : "N";
            } else {
