...
<jsp:include page="/WEB-INF/views/nav.jsp" />
    ...
    <section>        
        <div id="contain">
            ...
            <div id="main">
            	<form id="verifyForm" method="post" action="${pageContext.request.contextPath}/verifyCode">
            	<sec:csrfInput />
            	<!-- 인증 방식 선택 탭 -->
				<div id="authTabs">
                ...
                <div id="telWrap">
                    ...
                    <p class="explain">회원정보에 등록한 휴대전화 번호와 입력한 휴대전화 번호가 같아야, 아이디를 찾으실 수 있습니다.</p>
                    <div class="content">
                ...
                <div id="emailWrap">
                    <h3>본인확인 이메일로 인증</h3>
                    <p class="explain">본인확인 이메일 주소와 입력한 이메일 주소가 같아야, 아이디를 찾으실 수 있습니다.</p>
                    <div class="content">
	                    <label class="tag">이름</label>
                ...
                <div id="bottomRow">
				    <button type="submit" id="verifyBtn">인증 및 아이디 확인</button>
                </div>
                </form>
            </div>        
        </div>
...
$(document).ready(function(){
	...
	$("#verifyForm").on("submit", function (e) {
        ...
        const emailCode = $("#emailCode").val().trim();
	 	...
	 	// 에러 초기화
	    $("#telNameErrMsg, #emailNameErrMsg, #telErrMsg, #emailErrMsg, #telCodeErrMsg, #emailCodeErrMsg").html("");
